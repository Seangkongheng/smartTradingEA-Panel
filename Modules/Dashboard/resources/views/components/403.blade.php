...
<body>
    <div class="flex items-center justify-center min-h-screen bg-gray-50">
        <div class="text-center relative">
            ...
            <img src="{{ asset('images/403-image.png') }}" alt="403 Forbidden" class="mx-auto w-full max-w-lg md:max-w-2xl mb-4 error-image animate__animated animate__fadeIn">
            ...
            <div class="overlay-text p-6 mx-4 md:mx-0">
                ...
                <p class="mt-2 text-sm md:text-base text-gray-600 animate__animated animate__fadeInUp">
                    The page has restricted access. Please refer to your system administrator.
                </p>

                <!-- Go Back Button -->
                <a href="{{ url()->previous() }}"class="mt-4 inline-block px-8 py-3 bg-green-500 text-white text-base font-semibold rounded-full btn-custom animate__animated animate__fadeInUp">
                    Go Back
                </a>
            </div>
        </div>

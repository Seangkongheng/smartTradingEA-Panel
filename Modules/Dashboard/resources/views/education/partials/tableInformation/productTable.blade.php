<table id="table-data" class="w-full text-left text-sm text-gray-300">
    ...
    <tbody class="divide-y divide-gray-700">
        @forelse ($educations as $i => $education)
            <tr class="hover:bg-gray-800/40 transition">
                ...
                {{ $education->is_public ? 'bg-green-500/10 text-green-400' : 'bg-red-500/10 text-red-400' }}">
                        <span
                            class="w-2 h-2 rounded-full
                        {{ $education->is_public ? 'bg-green-400' : 'bg-red-400' }}">
                        </span>

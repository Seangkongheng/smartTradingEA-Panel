<main>
    <section>
        <div class="grid grid-cols-12 gap-1 min-h-screen">
            {{-- <div class="dashboard-siderbar hidden xl:block xl:col-start-1 xl:col-end-3 bg-gray-50/15   sticky top-0 h-screen z-50" id="dashboard-siderbar" style="position: sticky;top: 0;box-shadow: rgba(17, 17, 26, 0.05) 0px 2px 8px, rgba(17, 17, 26, 0.05) 0px 0px 32px;">
                @include('dashboard::layout.partials.siderbar')
            </div> --}}
            <div id="dashboard-siderbar"
                class="dashboard-siderbar xl:col-start-1 xl:col-end-3 fixed xl:sticky xl:block  overflow-auto top-0 left-0 z-50 h-screen  bg-white transform -translate-x-full xl:translate-x-0 transition-transform duration-300 ease-in-out"

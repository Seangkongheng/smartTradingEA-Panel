<aside class="w-full">
    <div class="siderbar-full-content w-full">
        ...
        <div class="siderbar-componet flex flex-col gap-2 px-5 py-4">
            ...
            <!-- Dashboard -->
            <div
                class="componet-content w-full hover:bg-green-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl">
            ...
            <div
                class="componet-content w-full hover:bg-green-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl">
                <a href="{{ route('admin.vip-tools.index') }}">
                    <div class="flex items-center w-full min-h-12 gap-2 text-lg kantumruy-pro">
                        <div class="component-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M2 17l5-5 5 5 5-5 5 5v4H2z"></path>
                                <path d="M2 13l5-8 5 8 5-8 5 8"></path>
                            </svg>
                        </div>
                        <div class="component-txt">VIP Tool</div>
                    </div>
                </a>
            </div>
            ...
            <!-- Logout -->
            <div
                class="componet-content w-full text-red-500 hover:bg-red-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl mt-4">

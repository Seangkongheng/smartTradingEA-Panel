<aside class="w-full">
    <div class="siderbar-full-content w-full">
        ...
        <div class="siderbar-componet flex flex-col gap-2 px-5 py-4">
            ...
            <div class="componet-content w-full hover:bg-green-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl">
                <a href="{{ route('admin.index') }}">
                    <div class="flex items-center w-full min-h-12 gap-2 text-lg kantumruy-pro">
                        ...
                        <div class="component-txt">Dashboard</div>
                    </div>
                </a>
            </div>

            <!-- User Management Section -->
            <div class="px-5 mt-4 mb-1 text-gray-500 font-semibold text-sm uppercase">User Management</div>
            ...
            <div class="componet-content w-full hover:bg-green-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl">
                <a href="{{ route('admin.register.index') }}">
                    <div class="flex items-center w-full min-h-12 gap-2 text-lg kantumruy-pro">
                        <div class="component-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" class="fill-current">
                                <path d="M560-440q-50 0-85-35t-35-85q0-50 35-85t85-35q50 0 85 35t35 85q0 50-35 85t-85 35ZM280-320q-33 0-56.5-23.5T200-400v-320q0-33 23.5-56.5T280-800h560q33 0 56.5 23.5T920-720v320q0 33-23.5 56.5T840-320H280Zm80-80h400q0-42 29-71t71-29v-160q-42 0-71-29t-29-71H360q0 42-29 71t-71 29v160q42 0 71 29t29 71Zm440 240H120q-33 0-56.5-23.5T40-240v-440h80v440h680v80ZM280-400v-320 320Z" />
                            </svg>
                        </div>
                        <div class="component-txt">Register</div>
                    </div>
                </a>
            </div>
            ...
            <div class="componet-content w-full hover:bg-green-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl">
                <a href="{{ route('admin.membership.index') }}">
                    <div class="flex items-center w-full min-h-12 gap-2 text-lg kantumruy-pro">
                        ...
                        <div class="component-txt">Membership</div>
                    </div>
                </a>
            </div>
            ...
            <div class="componet-content w-full hover:bg-green-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl">
                <a href="{{ route('admin.rewards.index') }}">
                    <div class="flex items-center w-full min-h-12 gap-2 text-lg kantumruy-pro">
                        ...
                        <div class="component-txt">Reward</div>
                    </div>
                </a>
            </div>
                    ...
                    <div class="flex items-center w-full min-h-12 gap-2 text-lg kantumruy-pro">
                        <div class="component-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 .86 1.65 1.65 0 0 1-3 0 1.65 1.65 0 0 0-1-.86 1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-.86-1 1.65 1.65 0 0 1 0-3 1.65 1.65 0 0 0 .86-1 1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33h.01a1.65 1.65 0 0 0 1-.86 1.65 1.65 0 0 1 3 0 1.65 1.65 0 0 0 1 .86h.01a1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82v.01a1.65 1.65 0 0 0 .86 1 1.65 1.65 0 0 1 0 3 1.65 1.65 0 0 0-.86 1z"></path>
                            </svg>
                        </div>
                        <div class="component-txt">EA Settings</div>
                    </div>
                </a>
            </div>
            ...
            <!-- Result Categories -->
            <div class="componet-content w-full hover:bg-green-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl">
                <a href="{{ route('admin.result-categories.index') }}">
                    <div class="flex items-center w-full min-h-12 gap-2 text-lg kantumruy-pro">
                        <div class="component-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="component-txt">Result Categories</div>
                    </div>
                </a>
            </div>
            ...
            <!-- Result Photos -->
            <div class="componet-content w-full hover:bg-green-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl">
                <a href="{{ route('admin.result-photos.index') }}">
                    <div class="flex items-center w-full min-h-12 gap-2 text-lg kantumruy-pro">
                        <div class="component-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="component-txt">Result Photos</div>
                    </div>
                </a>
            </div>

            <!-- Education & Community Section -->
            <div class="px-5 mt-4 mb-1 text-gray-500 font-semibold text-sm uppercase">Education & Community</div>
            ...
            <div class="componet-content w-full hover:bg-green-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl">
                <a href="{{ route('admin.marketplace.index') }}">
                    <div class="flex items-center w-full min-h-12 gap-2 text-lg kantumruy-pro">
                        ...
                        <div class="component-txt">Marketplace</div>
                    </div>
                </a>
            </div>
            ...
            <div class="componet-content w-full hover:bg-green-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl">
                <a href="{{ route('admin.plan.index') }}">
                    <div class="flex items-center w-full min-h-12 gap-2 text-lg kantumruy-pro">
                        ...
                        <div class="component-txt">Marketplace Plans</div>
                    </div>
                </a>
            </div>
            ...
            <div class="componet-content w-full hover:bg-green-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl">
                <a href="{{ route('admin.subscribes.index') }}">
                    <div class="flex items-center w-full min-h-12 gap-2 text-lg kantumruy-pro">
                        ...
                        <div class="component-txt">Subscriptions</div>
                    </div>
                </a>
            </div>

            <!-- Files & Media Section -->
            <div class="px-5 mt-4 mb-1 text-gray-500 font-semibold text-sm uppercase">Files & Media</div>
            ...
            <div class="componet-content w-full hover:bg-green-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl">
                <a href="{{ route('admin.attachment.index') }}">
                    <div class="flex items-center w-full min-h-12 gap-2 text-lg kantumruy-pro">
                        <div class="component-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M21.44 11.05l-9.19 9.19a6 6 0 01-8.49-8.49l9.19-9.19a4 4 0 015.66 5.66l-9.19 9.19a2 2 0 01-2.83-2.83l8.48-8.48" />
                            </svg>
                        </div>
                        <div class="component-txt">Attachments</div>
                    </div>
                </a>
            </div>

            <!-- System Section -->
            <div class="px-5 mt-4 mb-1 text-gray-500 font-semibold text-sm uppercase">System</div>
            ...
            <div class="componet-content w-full hover:bg-green-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl">
                <a href="{{ route('admin.user.index') }}">
                    <div class="flex items-center w-full min-h-12 gap-2 text-lg kantumruy-pro">
                        ...
                        <div class="component-txt">Users</div>
                    </div>
                </a>
            </div>
            ...
            <div class="componet-content w-full hover:bg-green-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl">
                <a href="{{ route('admin.setting.index') }}">
                    <div class="flex items-center w-full min-h-12 gap-2 text-lg kantumruy-pro">
                        ...
                        <div class="component-txt">Settings</div>
                    </div>
                </a>
            </div>

            <!-- Logout -->
            <div class="componet-content w-full text-red-500 hover:bg-red-600 transition-all duration-300 ease-in-out hover:text-white cursor-pointer px-5 rounded-xl mt-4">
                <a href="{{ route('admin.logout') }}">
                    <div class="flex items-center w-full min-h-12 gap-2 text-lg kantumruy-pro">
                        <div class="component-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" class="fill-current rotate-180">
                                <path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h280v80H200v560h280v80H200Zm440-160-55-58 102-102H360v-80h327L585-622l55-58 200 200-200 200Z" />
                            </svg>
                        </div>
                        <div class="component-txt">Logout</div>
                    </div>
                </a>
            </div>

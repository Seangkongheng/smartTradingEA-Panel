        ...
        <tr class="hover:bg-gray-800/40 transition">
            ...
            <td class="px-6 py-4">
                <div class="flex justify-center gap-2">
                    {{-- View --}}
                    <a href="{{ route('admin.user.show', $userRegister->id) }}"
                    ...
                    {{-- Edit --}}
                    <a href="{{ route('admin.attachment.edit', $userRegister->id) }}"
                    ...
                    <form action="{{ route('admin.attachment.destroy', $userRegister->id) }}" method="POST"

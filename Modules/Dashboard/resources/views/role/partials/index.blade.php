...
<div class="title-table mt-5 flex items-center justify-between gap-4">
    ...
    <div class="flex-1 min-w-[160px]">
        <h1 class="text-xl font-semibold text-gray-800 kantumruy-pro">
            <span class="text-green-600">តួនាទី (Roles)</span>
    ...
    <div class="flex items-center gap-3 flex-1 max-w-[800px]">
        ...
        <!-- Add Button -->
        <a href="{{ route('admin.role.create') }}" class="flex items-center gap-2 px-4 py-2.5 rounded-lg border border-green-600 bg-white hover:bg-green-50 transition-colors">
...
{{-- start main --}}
    @include('dashboard::role.partials.tableInformation.roleTable')
{{-- end main --}}

<div class="tab-content hidden" id="roles-settings">
    <div class="space-y-6 relative ">
        ...
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.role.create') }}" class=" bg-green-600 text-white rounded-full p-2 shadow-lg hover:bg-green-700 transition-all duration-200 flex items-center">
        ...
        @if(count($roles) >= 6)
            <div class="view-all flex justify-center items-center p-3">
                <div class="view-all-content flex items-center gap-2">
                    <a href="{{ route('admin.role.index') }}"><span class="text-green-600">មើលទាំងអស់</span></a>

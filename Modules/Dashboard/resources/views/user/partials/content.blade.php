...
<div class="title-table mt-5 flex flex-col md:flex-row  items-center justify-between gap-4">
    ...
    <div class="flex-1 flex justify-between w-full md:min-w-[160px]">
        <h1 class="text-xl font-semibold text-gray-800 kantumruy-pro m-0 p-0">
            <span class="text-green-600">អ្នកប្រើប្រាស់</span></span>
            <span class="text-gray-300 mx-2">/</span>
            <span class="text-gray-600">តារាង</span>
        </h1>
         <a href="{{ route('admin.user.create') }}" class="flex md:hidden items-center gap-2 px-4 py-2.5 rounded-lg border border-green-600 bg-white hover:bg-green-50 transition-colors">
    ...
    <div class="flex items-center justify-start  gap-3 flex-1 w-full md:max-w-[800px]">
        <div class="flex-1 md:min-w-[160px]">
            <form action="" method="POST">
                <div class="relative">
                    <input type="text" id="search" name="search" placeholder="ស្វែងរក..." class="w-full kantumruy-pro pl-10 pr-4 py-2.5 rounded-lg border border-gray-200 bg-gray-50  focus:ring-1 focus:ring-green-400 focus:border-green-400 focus:outline-none placeholder-gray-400 text-gray-700 focus:border-none transition-all">
        ...
        <!-- Add Button -->
        <a href="{{ route('admin.user.create') }}" class="hidden md:flex items-center gap-2 px-4 py-2.5 rounded-lg border border-green-600 bg-white hover:bg-green-50 transition-colors">
            <svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
            </svg>
            <span class="kantumruy-pro font-medium text-green-600">បន្ថែម</span>
    ...
    <div class="main-full-content w-full">
        <div class="table-content w-full">
            <div class="relative overflow-x-auto sm:rounded-lg">
               @include('dashboard::user.partials.tableInformation.userTable')
            </div>
        </div>
    </div>
</div>

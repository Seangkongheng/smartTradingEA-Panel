<div class="tab-content hidden  rounded-lg bg-[#131d41] " id="styled-dashboard" role="tabpanel"  style="box-shadow: rgba(17, 17, 26, 0.05) 0px 2px 8px, rgba(17, 17, 26, 0.05) 0px 0px 32px;">

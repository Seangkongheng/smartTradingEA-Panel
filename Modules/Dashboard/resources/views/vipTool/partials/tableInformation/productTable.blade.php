    ...
    <tbody class="divide-y divide-gray-700">
        ...
        <tr class="hover:bg-gray-800/40 transition">
            ...
            <td class="px-6 py-4">
                ...
                {{ $vipTool->is_public ? 'bg-green-500/10 text-green-400' : 'bg-red-500/10 text-red-400' }}">
                    <span class="w-2 h-2 rounded-full
                        {{ $vipTool->is_public ? 'bg-green-400' : 'bg-red-400' }}">
                    </span>

                    {{ $vipTool->is_public ? 'Public' : 'Private' }}
                </span>
            </td>
            ...
            <td class="px-6 py-4">
                <div class="flex justify-center gap-2">
                    ...
                    <a href="{{ route('admin.vip-tools.edit', $vipTool->id) }}"
                    ...
                    <form action="{{ route('admin.vip-tools.destroy', $vipTool->id) }}" method="POST"
